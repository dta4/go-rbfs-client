...
/*
ActionsApiService Traces the LSP to the given destination IP prefix (FEC).
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ActionsApiTracerouteMplsOpts - Optional Parameters:
     * @param "FecType" (optional.String) -  The FEC type.
...
type ActionsApiTracerouteMplsOpts struct {
	FecType          optional.String
	DestinationIpFec optional.String
	DestinationAaaa  optional.String
	DestinationA     optional.String
...
func (a *ActionsApiService) TracerouteMpls(ctx context.Context, localVarOptionals *ActionsApiTracerouteMplsOpts) (Traceroute, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/actions/traceroute-mpls"
